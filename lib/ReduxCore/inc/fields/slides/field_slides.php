    ...
    class ReduxFramework_slides {
        ...
        public function render() {
            ...
            if ($x == 0) {
                ...
                echo '<li><input type="' . $title_type . '" id="' . $this->field['id'] . '-subtitle_' . $x . '" name="' . $this->field['name'] . '[' . $x . '][subtitle]' . '" value="' . esc_attr($slide['subtitle']) . '" placeholder="' . $placeholder . '" class="full-text slide-title" /></li>';
